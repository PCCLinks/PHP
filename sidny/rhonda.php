...
<body class="R2">
	<div class="container">
		...
		<?php if($_SESSION['contactID']>0) include 'common/inc_student_header.php' ;?>
...
<script type="text/javascript">
	$(function() {
		...
		$("#tabs").tabs("option", "disabled", [3,4,5,6,7]);//disable all program tabs
		...
		if(pdCount > 0 )$("#tabs").tabs("enable", 6);  //enable the Project Degree tab
		if(fcCount > 0 )$("#tabs").tabs("enable", 7);  //enable the Future Connect tab
