...
if(!empty($errorMsg)){
    ...
    // , tmpReportRS.rsName as RSname, tmpReportSD.schoolDistrict
        ...
        $sql = "SELECT a.exitReason, a.Number_of_Students from 
           (SELECT count(reasonText) as Number_of_Students, reasonText as exitReason, tmpReportStatus.contactID FROM tmpReportReason LEFT JOIN tmpReportStatus on tmpReportReason.contactID = tmpReportStatus.contactID ";
           if($searchResourceSpecialistID) $sql .= " LEFT JOIN tmpReportRS ON tmpReportReason.contactID = tmpReportRS.contactID ";
           if($searchSchoolDistrictID) $sql .= " LEFT JOIN tmpReportSD ON tmpReportSD.contactID = tmpReportStatus.contactID ";
