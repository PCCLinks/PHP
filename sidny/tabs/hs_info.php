	   ...
	   <legend>High School Credits</legend>
	    <ol class='dataform'>
			<li>
				...
				<input type='text' name='hsCreditsEntry' id='hsCreditsEntry' class='textInput' tabindex='1' value='<?php echo $hsCreditsEntry ?>' onchange="validateHS(this.form.id,this.name,this.value, 'contact', 1)"/>          <!-- gtc changed to contact -->
			</li> 
			<li>
				<label for='hsGpaEntry'>HS GPA at Entry  </label>
				<input type='text' name='hsGpaEntry' id='hsGpaEntry' class='textInput' tabindex='3' value='<?php echo $hsGpaEntry ?>' onchange="validateHS(this.form.id,this.name,this.value, 'contact', 1)"/>
			</li>
                     <li>
				<label for='yearStartedHS'>Year Started HS </label>
				<input type='text' name='yearStartedHS' id='yearStartedHS' class='textInput' tabindex='3' value='<?php echo $yearStartedHS ?>' onchange="validateHS(this.form.id,this.name,this.value, 'contact', 1)"/>
			</li>
                     <li>
				<label for='lastHSattended'>Last HS attended</label>
				<input type='text' name='lastHSattended' id='lastHSattended' class='textInput' tabindex='3' value='<?php echo $lastHSattended ?>' onchange="validateHS(this.form.id,this.name,this.value, 'contact', 1)"/>
			</li>
	       </ol>
	</fieldset>
	<input type='submit' id='submit' value='Submit HSInfo' name='submitByButton' />
    </form>
