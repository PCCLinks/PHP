...
<script type="text/javascript">
	...
	//Datepicker
       ...
       $('#gedLanguageArtsDate').datepicker({ dateFormat: 'yy-mm-dd' });
...
<table id='gedTestScores' class='tablesorter'>
	...
	<tr>
            <th>Language Arts</th>
            <td>Score:<input type='text' name='gedLanguageArtsScore' id='gedLanguageArtsScore' class='textInput' tabindex='4' value='<?php echo $gedLanguageArtsScore ?>' onchange="validateYES(this.form.id,this.name,this.value,'yes', 0)"/></td>
            <td>Date:<input type='text' name='gedLanguageArtsDate' id='gedLanguageArtsDate' class='textInput' tabindex='5' value='<?php echo $gedLanguageArtsDate ?>' onchange="validateYES(this.form.id,this.name,this.value,'yes', 0)"/></td>
            <td>Attempt:
	    <select name='gedLanguageArtsAttemptNum' id='gedLanguageArtsAttemptNum' class='textInput' tabindex='12' value='<?php echo $gedLanguageArtsAttemptNum ?>' onchange="validateYES(this.form.id,this.name,this[this.selectedIndex].value, 'yes', 0)">";
	    <?php echo attemptGED($gedLanguageArtsAttemptNum, 5) ;?>
	    </td>
	</tr>
	<tr>
            <th>Soc Studies</th>
