...
//       $sql_dropped = "SELECT count(a.date_diff) as total_dropped FROM (SELECT datediff(tmpReportExited.lastExitDate, tmpReportExited.lastEntryDate) as date_diff, tmpReportExited.contactID FROM tmpReportExited ) a WHERE a.date_diff < 30 ";
    ...
    $sql = "SELECT contact.contactID AS contactID, contact.firstName, contact.lastName, contact.bannerGNumber, tmpReportSD.studentDistrictNumber, contact.emailPCC, contact.dob, contact.race, contact.ethnicity, keyStatus.statusText as currentStatus ";
