				...
				case 'topCareers':
					...
					order by count(distinct crf.contactID) DESC";
						...
						case 'topCareers':
							...
							$sql = "select careerIndustryName 'Career Industry', count(distinct contactID) '# of Students'
						from contactCareerIndustry cci
						join careerIndustry ci on cci.careerIndustryID = ci.careerIndustryID
						group by careerIndustryName
