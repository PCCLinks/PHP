...
//GTC Applications
	...
	$arrBatchFields = array(
	    array("table" => "contact",
                  "identityFields" => array("firstName","lastName","bannerGNumber", "emailPCC", "mailingStreet", "mailingCity", "mailingState", "mailingZip", "phoneNum1", "phoneType1", "phoneNum2", "phoneType2", "dob")),
	    array("table" => "gtc",
                  "indexFields" => array("gtcID"),
                  "updateFields" => array("apiDate", "eval1Date", "eval2Date","interviewDate","termApplyingFor", "termAccepted", "hsCreditsEntry", "hsGpaEntry", "apiGrade", "apiRawScore", "eligibleFor", "gtcLocation", "gtcScore", "evalReadingScore", "evalHomework", "evalEssayScore", "evalMathScore", "evalGrammarScore", "evalIdeaContentScore", "evalOrganizationScore",  "interviewCompleted", "interviewScore"))
	);
	...
	$arrBatchFields = array(
	    array("table" => "contact",
                  "identityFields" => array("firstName","lastName","bannerGNumber","dob")),
	    array("table" => "gtc",
                  "indexFields" => array("gtcID"),
                  "updateFields" => array("apiDate", "eval1Date", "eval2Date","termAccepted", "apiGrade", "apiRawScore", "gtcScore", "eligibleFor", "gtcLocation", "evalReadingScore", "evalHomework", "evalEssayScore", "evalMathScore", "evalGrammarScore", "evalIdeaContentScore", "evalOrganizationScore"))
	);
...
//GTC Set Applicant as Enrolled
	...
	$arrBatchFields = array(
	    array("table" => "contact",
                  "identityFields" => array("firstName","lastName","bannerGNumber","dob")),
	    array("table" => "status",
                  "insertFields" => array("statusDate","contactID","keyStatusID","program","statusNotes")),
	    array("table" => "gtc",
                  "indexFields" => array("gtcID"),
...
//GTC Full Table
	...
	$arrDataCheck = array(
	  ...
	  //evaluation     
	       ...
	       "gtc.interviewScore" => array("required" => "false", "type"=> "float", "rule"=> "minmax", "max"=>100 ),
	       "gtc.evalHomework" => array("required" => "false", "type"=> "str"),            // , "rule"=> "yn"),
	       "gtc.evalReadingScore" => array("required" => "false", "type"=> "int"), // "float", "rule"=> "minmax", "max"=>100 ),
	       "gtc.evalEssayScore" => array("required" => "false", "type"=> "int"),   // "float", "rule"=> "minmax", "max"=>100 ),     
	       "gtc.evalGrammarScore" => array("required" => "false", "type"=> "int"), // "float", "rule"=> "minmax", "max"=>100 ),
	       "gtc.evalMathScore" => array("required" => "false", "type"=> "int"),    // "float", "rule"=> "minmax", "max"=>100 ),
	       "gtc.evalIdeaContentScore" => array("required" => "false", "type"=> "int"),
	       "gtc.evalOrganizationScore" => array("required" => "false", "type"=> "int"),
	  //hs     
	       "gtc.hsCreditsEntry" => array("required" => "false", "type"=> "float"),
	       "gtc.hsGpaEntry" => array("required" => "false", "type"=> "float"),
	  //placement 
...
//GTC Set School District
	...
	$arrBatchFields = array(
	    ...
	    array("table" => "status",
                  "insertFields" => array("statusDate","contactID","keyStatusID","statusNotes")),
	...
	$arrDataCheck = array(
	       "status.contactID" => array("required" => "true", "type"=> "int"),
	   //    "status.keyStatusID" => array("required" => "true", "type"=> "int"),    
         //     "status.statusDate" => array("required" => "true", "type"=> "date"),
	  ...
	  //     "statusSchoolDistrict.studentDistrictNumber" => array("required" => "true", "type"=> "int")
              ...
              //, "rule"=> "checkValue", "value" =>7), - for keyStatusID field
...
//MAP Full Table
	...
	$arrBatchFields = array(
	    array("table" => "contact", "identityFields" => array("firstName","lastName","bannerGNumber","dob")),
	    array("table" => "map", "indexFields" => array("mapID"), "updateFields" => array("iptTestDate","gedMapCompletionDate","gedMapWritingDate","gedMapSocStudiesDate","gedMapScienceDate","gedMapLitDate","gedMapMathDate","mapRecordStart","mapRecordLast","iptCompositeScore","iptLanguageLevel","iptSchoolScore","oralScore","oralLevel","readingScore","readingLevel","writing1","writing2","writing3","writingTotal","writingLevel","wccSpanishPlacementScore","job","jobHours","foreignTranscript","foreignTranscriptVerified","mapTime","mapLocation","gedMapAccessCode","gedMapHonors","gedMapWritingScore","gedMapWritingAttemptNum","gedMapSocStudiesScore","gedMapSocStudiesAttemptNum","gedMapScienceScore","gedMapScienceAttemptNum","gedMapLitScore","gedMapLitAttemptNum","gedMapMathScore","gedMapMathAttemptNum"))
	);
        //Set array for fields that need a data check for this batch
	$arrDataCheck = array(
	    ...
	    //   "map.oralLevel" => array("required" => "false", "type"=> "int"),            // changed from str from here on up to ..
	   //    "map.readingScore" => array("required" => "false", "type"=> "int"),
	       "map.readingLevel" => array("required" => "false", "type"=> "int")            // ,      
	   //    "map.writing1" => array("required" => "false", "type"=> "int"),
	  //     "map.writing2" => array("required" => "false", "type"=> "int"),
	  //     "map.writing3" => array("required" => "false", "type"=> "int"),
	  //     "map.writingTotal" => array("required" => "false", "type"=> "int"),
	  //     "map.writingLevel" => array("required" => "false", "type"=> "int"),
	  //     "map.job" => array("required" => "false", "type"=> "int"),                  // .. upto here
	  //     "map.jobHours" => array("required" => "false", "type"=> "str"),             //, "rule"=> "jobHours"),
	 //      "map.foreignTranscript" => array("required" => "false", "type"=> "int"),    // "str", "rule"=> "checkbox"),
	 //      "map.foreignTranscriptVerified" => array("required" => "false", "type"=> "int"),   // "str", "rule"=> "checkbox"),
	  ...
	  //     "map.gedMapAccessCode" => array("required" => "false", "type"=> "str"),    //gedAccessCode to gedMapAccessCode; date to str
	 //      "map.gedMapCompletionDate" => array("required" => "false", "type"=> "date"),  // added Map
	 //      "map.gedMapHonors" => array("required" => "false", "type"=> "str"),             // added Map; date to str
	 //      "map.gedMapWritingDate" => array("required" => "false", "type"=> "date"),       // added Map
	 //      "map.gedMapWritingScore" => array("required" => "false", "type"=> "str"),
	 //      "map.gedMapWritingAttemptNum" => array("required" => "false", "type"=> "int"),   // , "rule"=> "minmax"), "min"=>0, "max"=>5 ),
	 //      "map.gedMapSocStudiesDate" => array("required" => "false", "type"=> "date"),
	 //      "map.gedMapSocStudiesScore" => array("required" => "false", "type"=> "str"),
	 //      "map.gedMapSocStudiesAttemptNum" => array("required" => "false", "type"=> "int"), // , "rule"=> "minmax", "min"=>0, "max"=>5 ),
	 //      "map.gedMapScineceDate" => array("required" => "false", "type"=> "date"),
	 //      "map.gedMapScineceScore" => array("required" => "false", "type"=> "str"),
	 //      "map.gedMapScineceAttemptNum" => array("required" => "false", "type"=> "int"),  // , "rule"=> "minmax", "min"=>0, "max"=>5 ),
	//       "map.gedMapLitDate" => array("required" => "false", "type"=> "date"),
	 //      "map.gedMapLitScore" => array("required" => "false", "type"=> "str"),
	 //      "map.gedMapLitAttemptNum" => array("required" => "false", "type"=> "int"),   // ,  "rule"=> "minmax", "min"=>0, "max"=>5 ),
	  //     "map.gedMapMathDate" => array("required" => "false", "type"=> "date"),
	  //     "map.gedMapMathScore" => array("required" => "false", "type"=> "str"),
	  //     "map.gedMapMathAttemptNum" => array("required" => "false", "type"=> "int")  //, "rule"=> "minmax", "min"=>0, "max"=>5 )
...
//YES Full Table
	...
	$arrBatchFields = array(
	    array("table" => "contact", "identityFields" => array("firstName","lastName","bannerGNumber","dob")),
	    array("table" => "yes", "indexFields" => array("yesID"), "updateFields" => array("gedCompletionDate","gedWritingDate","gedSocStudiesDate","gedScienceDate","gedLitDate","gedMathDate","yesRecordStart","yesRecordLast","gedAccessCode","gedHonors","gedWritingScore","gedWritingAttemptNum","gedSocStudiesScore","gedSocStudiesAttemptNum","gedScienceScore","gedScienceAttemptNum","gedLitScore","gedLitAttemptNum","gedMathScore","gedMathAttemptNum"))
	);
        //Set array for fields that need a data check for this batch
	$arrDataCheck = array(
...
//The cases 100 and higher all relate to full table query downloads.  These are called from the dbQuery page instead of the Batch page.
	...
	$fileExportName = "GTC-Full";
       $arrBatchFields = array(
	    array("table" => "gtc",
                  ...
                  "updateFields" => array("applicationDate","termApplyingFor","termAccepted","livingSituation","LivingSituationOther","schoolDistrict","hsCreditsEntry","hsGpaEntry","yearStartedHS","apiGrade","apiRawScore","apiDate","eval1Date","eval2Date","eligibleFor","gtcLocation","gtcScore","evalPlacement","evalReadingScore","evalHomework","evalEssayScore","evalGrammarScore","evalMathScore","evalIdeaContentScore","evalOrganizationScore","interviewDate","interviewCompleted","interviewScore","lettersent","lettersentdate","termProjectedGraduation","cohortNumber1","cohortNumber2","cohortNumber3","transitionGTC","transitionPreGTC","preGatewayOnly","cohortNumberPre1","cohortNumberPre2","gtcRecordStart","gtcRecordLast"))
       );
       $sqlFields = fieldList($arrBatchFields);
   ...
   case 140:
    ...
    case 145:
        //date will be added to file name on export
	$fileExportName = "YTC-Full";
       $arrBatchFields = array(
	    array("table" => "ytc", "indexFields" => array("ytcID",contactID), "updateFields" => array(
"iptTestDate", "iptCompositeScore", "iptLanguageLevel", "iptSchoolScore", "oralScore", "oralLevel", "readingScore", "readingLevel", 
"writing1", "writing2", "writing3", "writingTotal", "writingLevel", "wccSpanishPlacementScore", "job", "jobHours", 
"foreignTranscript", "foreignTranscriptVerified", "mapTime", "mapLocation", 
"gedMapAccessCode","gedMapCompletionDate","gedMapHonors", "gedMapWritingScore","gedMapWritingDate","gedMapWritingAttemptNum","gedMapSocStudiesScore","gedMapSocStudiesDate","gedMapSocStudiesAttemptNum", "gedMapScienceScore","gedMapScienceDate","gedMapScienceAttemptNum","gedMapLitScore","gedMapLitDate","gedMapLitAttemptNum","gedMapMathScore","gedMapMathDate","gedMapMathAttemptNum","gedMapLanguageArtsScore","gedMapLanguageArtsDate","gedMapLanguageArtsAttemptNum", "ytcRecordStart","ytcRecordLast"))
       );
       $sqlFields = fieldList($arrBatchFields);
	$batchSQL = "SELECT * FROM ytc ";
    break;
	...
	$fileExportName = "FC-Full";
       $arrBatchFields = array( 
               array("table" => "fc", "indexFields" => array("fcID"), "updateFields" => array("contactID","expectedGraduation", "reading", "writing", "math", "sycProgram", "pccEnrollmentStatus","careerPlans", "householdInformation", "livingSituation", "financialNeed", "fcRecordStart", "fcRecordLast" ) )
                              );
       $sqlFields = fieldList($arrBatchFields);
