...
//Create form inputs for exit reasons.
    ...
    $SQLexitReason = "SELECT * FROM keyStatusReason WHERE reasonArea = 'exitStatus'" ;
...
<body class="R2">
	<div class="container">
		...
		<div class="clear view-content">
		    <div id='findReport'>
		    	<form id='fReport' accept-charset='UTF-8' class="cmxform" method='post' action='tabs/reports_table_v2.php'>
			...
			<fieldset class='group1'>
			    ...
			    <ol class='dataform' id='searchByTerm'>
				    <li>
					    <label for='searchTermYear'>Term Year:</label>
					    <input type='text' maxlength='128' name='searchTermYear' id='searchTermYear' size='15' value='<?php echo $_SESSION['searchTermYear']; ?>' title='Enter the start date of the report.' />
				    </li>
				    <li>
